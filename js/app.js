...
function cargarEventListeners() {
    ...
    // Mostrar los cursos que existan en el localStorage
    document.addEventListener("DOMContentLoaded", () => {
        articulosCarrito = JSON.parse(localStorage.getItem("cursosCarrito")) || [];
        carritoHTML();
    });
...
function sincronizarStorage() {
    ...
    localStorage.setItem("cursosCarrito", JSON.stringify(articulosCarrito));
